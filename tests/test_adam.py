...
def main():
    ...
    opt1 = bmt.optim.AdamOptimizer(model1.parameters(), weight_decay=1e-3, scale=1)
    opt2 = bmt.optim.AdamOffloadOptimizer(model2.parameters(), weight_decay=1e-3, scale=1)
