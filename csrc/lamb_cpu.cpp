...
void lamb_cpu_launcher(
    ...
    float numer = at::parallel_reduce(0, n, 0, 0.,
    ...
    float denom = at::parallel_reduce(0, n, 0, 0.,
        [&](int64_t start, int64_t end, float ident) -> float {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("f_lamb_cpu", &F_lamb_cpu, "lamb function cpu");
}
